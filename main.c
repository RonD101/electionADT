...
#define MAX_STR_LEN 10 //Must be greater than 1
#define MAX_VOTES 20 //Must be greater than 1
#define NUM_OF_AREAS 15 //Do not lower beneath 12
#define NUM_OF_TRIBES 15 //Do not lower beneath 12
